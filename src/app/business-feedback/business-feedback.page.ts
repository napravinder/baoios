...
@Component({
  ...
  templateUrl: './business-feedback.page.html',
  styleUrls: ['./business-feedback.page.scss'],
})
export class BusinessFeedbackPage implements OnInit {
  rate:any;trainerName:any;
    ...
    private loadingCtrl:LoadingController) {
      ...
      this.storageService.get('sno').then((sno) => {
        ...
        this.http.post('https://baobabsports.com/baosport/ios/get_trainer_feedback.php', {
          ...
          res => {
            this.res=res;
            this.trainerName=this.res['trainer'][0].name;
            
            if(this.res['trainer'][0].image){
              this.trainerImage="https://baobabsports.com/baosport/profile/trainer/"+this.res['trainer'][0].image;
            }
            this.postData.id=this.res['trainer'][0]['id'];
            if(this.res['overall_rate']>4){
              this.bad="bad";
              this.ok="ok";
              this.verygood="verygood";
              this.good="good";
              this.excellent="excellent";
            }else if(this.res['overall_rate']>3){
              this.bad="bad";
              this.ok="ok";
              this.good="good";
              this.verygood="verygood";
              this.excellent="notactive";
            }else if(this.res['overall_rate']>2){
              this.bad="bad";
              this.ok="ok";
              this.good="good";
            ...
            else if(this.res['overall_rate']>1){
              this.bad="bad";
              this.ok="ok";
              this.good="notactive";
              this.verygood="notactive";
